        ...
        modal.innerHTML =  `
            <form class="formulario nueva-tarea">
                ...
                <div class="campo">
                    ...
                    <input class="tarea" type="text" name="tarea" placeholder="${tarea.nombre ? 'Editar la tarea' : 'Añadir Tarea al Proyecto Actual'}" id="tarea" value="${tarea.nombre ? tarea.nombre : ''}"/>
                </div>
                <div class="opciones">
